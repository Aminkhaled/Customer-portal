			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">Show Invoices</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">Full Paid Invoices</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">Not Paid Invoices</a></li>
